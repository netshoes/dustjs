(function (root, factory) {
  ...
  return [
     ...
     */
    {
      ...
      tests: [
        ...
        },
        {
          ...
          context: {
            "emptyParamHelper": function (chunk, context, bodies, params) {
     ...
     */
    {
      ...
      tests: [
        ...
        },
        {
          ...
          context: {
            "promise": function () {
              return new FalsePromise(null, {"magic": "magic"});
            }
          },
          expected: "Eventually magic!",
        ...
        },
        {
          ...
          context: {
            "prince": "Prince",
            "magic": new FalsePromise(null, {"ally": {"delicious": new FalsePromise(null, "Lucky")}})
          },
        ...
        },
        {
          ...
          context: {
            mongo: {
              on: function () {
                throw new Error("Fooled you; I am not a stream!");
              },
              name: "Mongo"
            }
          },
        ...
        },
        {
          ...
          context: {
            "data": {
              "A": {
                "name": "Al",
                "list": [{"name": "Joe"}, {"name": "Mary"}],
                "B": {"name": "Bob", "Blist": ["BB1", "BB2"]}
              }
            }
          },
     ...
     */
    {
      ...
      tests: [
        ...
        },
        {
          ...
          source: '{>"{ref}" /}',
          context: {
            ref: function (chunk, context) {
              return chunk.map(function (chunk) {
                setTimeout(function () {
                  chunk.end('hello_world');
                }, 0);
              });
            }
          },
     ...
     */
    {
      ...
      tests: [
        ...
        },
        {
          ...
          context: {
            helper: function (chunk, context, bodies, params) {
              return chunk.write(params['data-foo']);
            }
          },
          expected: "dashes",
    ...
    /**
     * Rendering after everything else rendered
     */
    {
      name: "Delayed Chunks Rendering",
      tests: [
        {
          name: "Delayed chunk created is correctly rendered",
          source: "{@delayed}{/delayed}",
          context: {},
          expected: "Delayed content",
          message: "Content of the delayed chunk was not rendered."
        },
        {
          name: "Delayed chunk position is correctly keep",
          source: [
            "{#items}",
            "{.}",
            "{/items}",
          ...
          expected: "12345Delayed content12345",
          message: "Content of the delayed chunk was not rendered or its position is wrong."
        },
        {
          name: "Delayed chunk dynamic created on Helper",
          source: [
            "{#list}",
            "{.}",
            "{/list}",
          ...
          context: {
            list: function (chunk, context) {
              chunk.write(context.get('items').join(','));
              return chunk.map(function(chk){
                chk.delayed = true;
                chk.write('Another Delayed content');
              });
            },

            items: [1,2,3,4,5]
          },
          expected: "1,2,3,4,5Another Delayed contentDelayed content12345",
          message: "Content of the delayed chunk was not rendered or its position is wrong."
        },
        {
          name: "Partials delaying chunks",
          source: [
            '{#loadPartialTl}{/loadPartialTl}',
            'Foo',
            '{@delayed}{/delayed}',
          ...
          context: {
            loadPartialTl: function (chunk) {
              dust.loadSource(dust.compile('Hello {@delayed}{/delayed} World! ', 'HelloPartial'));
              return chunk;
            }
          },
          expected: "FooDelayed contentBarHello Delayed content World! Baz",
          message: "Content of the delayed chunk failed to correctly render trough Partial."
        }
      ]
    }
  ];
